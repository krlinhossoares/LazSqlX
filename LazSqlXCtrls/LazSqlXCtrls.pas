...
type
  ...
  { TLazSqlXTabSheet }
  TLazSqlXTypeEditor = (lzSqlEditor,lzSqlScript);
  ...
  private
    ...
    FTypeEditor: TLazSqlXTypeEditor;
    ...
    procedure SetTypeEditor(AValue: TLazSqlXTypeEditor);
  public
    ...
    property TypeEditor: TLazSqlXTypeEditor read FTypeEditor write SetTypeEditor;
  ...
  public
    ...
    function AddTab(TypeEditor: TLazSqlXTypeEditor = lzSqlEditor):TLazSqlXTabSheet;
...
procedure TLazSqlXTabSheet.SetTypeEditor(AValue: TLazSqlXTypeEditor);
begin
  if FTypeEditor=AValue then Exit;
  FTypeEditor:=AValue;
end;
...
begin
  ...
  if TypeEditor = lzSqlEditor then
...
begin
  ...
  tab.TypeEditor:= TypeEditor;
  if TypeEditor = lzSqlEditor then
    tab.Caption:= 'SQL Editor'
  else
    tab.Caption:= 'Script Executive';
