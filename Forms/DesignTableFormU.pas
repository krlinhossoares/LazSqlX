...
begin
  try
    try
     ...
     {case FDbInfo.DbType of Criava Triggers e generators.
       dtOracle,dtFirebirdd: if FWorkingTableInfo.Identities.Count>0 then
         dbcloner.MakeAutonumber(FWorkingTableInfo);
     end;}
